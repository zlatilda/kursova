...
def post_to_twitter(context, text, obj_or_url=None, link_text=''):
...
def post_to_facebook(context, obj_or_url=None, link_text=''):
...
def post_to_linkedin(context, title, obj_or_url=None, link_text=''):
...
def post_to_reddit(context, title, obj_or_url=None, link_text=''):
